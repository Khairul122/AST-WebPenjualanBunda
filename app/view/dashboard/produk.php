...
<body>
    ...
    <!-- Controller -->
    <?php include 'app/controller/dashboard/produk.php' ?>
    <!-- \Controller -->
                                                ...
                                                <div class="modal-body row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select class="form-control" name="id_kategori">
                                                            ...
                                                            <?php foreach ($viewKategori as $row) : ?>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-check-label">Harga Produk</label>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-check-label">Foto Produk</label>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body row">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <select class="form-control" name="id_kategori">
                                                                            <option value="" disabled selected>Pilih</option>
                                                                            <?php foreach ($viewKategori as $rowk) : ?>
                                                                                <?php if ($row['id_kategori'] == $rowk['id_kategori']) : ?>
                                                                                    <option value="<?= $rowk['id_kategori'] ?>" selected><?= $rowk['nama_kategori'] ?></option>
                                                                                <?php else : ?>
                                                                                    <option value="<?= $rowk['id_kategori'] ?>"><?= $rowk['nama_kategori'] ?></option>
                                                                                <?php endif ?>
                                                                            <?php endforeach ?>
                                                                        </select>
                                                                    </div>
